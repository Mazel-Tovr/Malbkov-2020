...
<body>
    <div class="container">
        ...
        <section>
            <div class="form">
                <div class="title"><h1>Редактировать автора</h1></div>
                <form method="POST" action="<%=request.getContextPath()%>/library/author/editingauthor">
                    <div class="form-style" >
                        ...
                        <div style="width: 16em;">
                            ...
                            <input type="text" name="secondName" value="${author.secondName}" />
                        </div>
