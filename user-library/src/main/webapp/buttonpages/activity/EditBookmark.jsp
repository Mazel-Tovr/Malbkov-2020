<html lang="en">
<%@ page import = "com.epam.library.model.Bookmark"  %>
<head>
...
<body>
    <div class="container">
        ...
        <section>
            <div class="form">
                <div class="title"><h1>Редактировать закладку</h1></div>
                <form method="POST" action="<%=request.getContextPath()%>/library/bookmark/editingbookmark">
                    <div class="form-style" >
                        <div style="width: 16em;">
                            <input style="display:none" type="number" name="bookId" value="${bookmark.bookId}" />
                        </div>
                        <div style="width: 16em;">
                            <span>Page number</span>
                            <input type="text" name="pageNumber" value="${bookmark.pageNumber}" />
                        </div>
                        <div style="width: 16em;">
